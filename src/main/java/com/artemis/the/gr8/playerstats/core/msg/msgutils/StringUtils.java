...
public final class StringUtils {
    ...
    public static String prettify(String input) {
        ...
        PluginLogger.logHighLevelMsg("Prettifying [" + input + "]");
        ...
        while (capitals.indexOf("_") != -1) {
            ...
            PluginLogger.logHighLevelMsg("Replacing underscores: " + capitals);
        }
        ...
        while (matcher.find()) {
            ...
            PluginLogger.logHighLevelMsg("Capitalizing names: " + capitals);
        }
